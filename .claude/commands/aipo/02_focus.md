...
4. [roles-templates](.claude/skills/aipo/roles-templates.md)
5. [session-rules](.claude/skills/aipo/session-rules.md)
6. [04_deliver](04_deliver.md)
7. [abstract-mode](.claude/skills/aipo/abstract-mode.md)
</aside>
...
📚 他のロール候補: [roles-templates](.claude/skills/aipo/roles-templates.md) 
...
1. **ロールテンプレート探索**
    - [roles-templates](.claude/skills/aipo/roles-templates.md) を参照し、利用可能なロール一覧を取得
    - 各ロールの適用シーンと分解特徴を把握
...
5. **提案の出力**
    ...
    - Goal性質、推奨戦略、分解方針を示す
    - 「この戦略で進めますか？」と確認
    - 📚 他のロール候補: [roles-templates](.claude/skills/aipo/roles-templates.md) へのリンクを含める
