...
7. [troubleshoot](.claude/skills/aipo/troubleshoot.md) - 操作相談スキル
</aside>
...
- [execution-rules](.claude/skills/aipo/execution-rules.md) - 共通ルール
- [abstract-mode](.claude/skills/aipo/abstract-mode.md) - 実装ガイド
