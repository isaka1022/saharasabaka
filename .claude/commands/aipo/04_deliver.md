...
2. [execution-rules](.claude/skills/aipo/execution-rules.md)
3. [command-templates](.claude/skills/aipo/command-templates.md)
4. [session-rules](.claude/skills/aipo/session-rules.md)
5. [04_deliver](04_deliver.md)
6. [abstract-mode](.claude/skills/aipo/abstract-mode.md)
7. [task-completion-rules](.claude/skills/aipo/task_completion_rules.md) - タスク完了時の必須ルール
8. [sync-progress](.claude/skills/aipo/sync_progress.md) - 進捗同期スキル
9. [troubleshoot](.claude/skills/aipo/troubleshoot.md) - 操作相談スキル
</aside>
...
- テンプレート（[command-templates](.claude/skills/aipo/command-templates.md)）を参照
</aside>
...
2. [command-templates](.claude/skills/aipo/command-templates.md) から類似テンプレートを探す
3. 柔軟に対応して成果物を生成
</aside>
...
- [execution-rules](.claude/skills/aipo/execution-rules.md) - 成果物ページ構造標準を含む共通ルール
- [abstract-mode](.claude/skills/aipo/abstract-mode.md) - Notion実装ガイド（実装系タスク時は必須）
...
3. **タスクタイプ判定と実装方針の決定**：
    - `type: implementation` の場合 → [abstract-mode](.claude/skills/aipo/abstract-mode.md) を参照
    - タスク名から実装内容を判定：
