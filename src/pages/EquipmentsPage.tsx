  ...
  const supportedEquipments: SponsoredEquipmentCategory[] = [
    {
      ...
      items: [
        ...
        },
        {
          ...
          brand: null,
          model: null,
          image: "/images/equipments/gee.jpg",
          description: "栄養補給の品として",
          sponsor: "やまざき たかまさ",
          sponsorLink: "https://amzn.to/3DJZ3sF",
          status: "未定" as const,
          link: "https://amzn.to/3DJZ3sF",
          weight: null,
          price: null
        },
        {
          ...
          brand: "コモライフ",
          model: null,
          image: "/images/equipments/no_water_shampoo.jpg",
          description: "洗わないシャンプー",
          sponsor: "K.I.",
          sponsorLink: "https://amzn.to/3DFW9VR",
          status: "未定" as const,
        ...
        },
        {
          name: "カレーライスセット",
          brand: "尾西食品",
          model: "CoCo壱番屋カレーライスセット",
          image: "/images/equipments/curry_rice_set.jpg",
          description: "カレーライスセット",
          sponsor: "K.I.",
          sponsorLink: "https://amzn.to/4byN7q5",
          status: "未定" as const,
          link: "https://amzn.to/4byN7q5",
          weight: null,
          price: null
        },
      ]
